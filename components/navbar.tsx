        ...
        <div className="flex items-center justify-between h-16 md:h-20">
          ...
          <Link href="#home" className="flex items-center gap-2 group" onClick={(e) => scrollToSection(e, "#home")}>
            <div className="relative w-10 h-10 md:w-12 md:h-12">
              ...
              <div className="absolute inset-0 bg-primary rounded-lg flex items-center justify-center transition-transform group-hover:scale-110">
                <span className="text-background font-bold text-xl md:text-2xl">N</span>
              </div>
            </div>
            <span className="font-bold text-lg md:text-xl text-foreground hidden sm:block">Nahidur Rahman</span>
          </Link>
